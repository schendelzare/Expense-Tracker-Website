...
const AddExpense = React.memo(() => {
  ...
  return (
    <div className="grid  grid-rows-2  md:grid-cols-2 mt-20 ">
      <div className="flex w-[300px] h-[350px]  mx-auto md:mr-0 border border-cgray hover:border-cyellow shadow-lg shadow-cgray text-cwhite">
        ...
        >
          ...
          <textarea
            ...
            name="remarks"
            required
            className="resize-none rounded-md outline-none text-center"
            maxLength={30}
          />
      ...
      <div>
        <div className="flex flex-col h-[200px] md:h-[350px] justify-center w-[300px] text-gray-200 mx-auto md:ml-0 px-6">
          <h2 className="md:text-lg font-semibold">Add Expense</h2>
          <p>
            Please input your expense and it will be dedecuted to your balance.
          </p>
        </div>
      </div>
    </div>
...
export async function action({ request }) {
  ...
  const response = await fetch(
    "https://expense-tracker-nodejs-dgov.onrender.com/api/transactions/addExpense",
    {
      method: "POST",
  ...
  window.alert("Add Expense Success!");
